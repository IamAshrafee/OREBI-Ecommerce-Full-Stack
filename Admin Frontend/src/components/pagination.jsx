...
export function PaginationPrevious({ to = null, className, children = 'Previous' }) {
  return (
...
export function PaginationNext({ to = null, className, children = 'Next' }) {
  return (
...
export function PaginationPage({ to, className, current = false, children }) {
  return (
    <Button
      to={to}
      plain

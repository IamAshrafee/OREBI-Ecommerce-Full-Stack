          ...
          >
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                <DialogTitle
                  as="h3"
                  className="text-xl mb-6 font-semibold text-gray-900 dark:text-white"
                >
                  Create New Category
                </DialogTitle>
                <div className="mt-4">
                  <label
                    htmlFor="name"
                    className="text-start block text-sm/6 font-medium text-gray-900 dark:text-white"
                  >
                    Category Name
                  </label>
                  <div className="mt-2">
            ...
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              ...
              <button
                type="button"
                onClick={() => setOpen(false)}
                className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto dark:bg-white/10 dark:text-white dark:ring-white/10 dark:hover:bg-white/20"
              >
                Cancel
              </button>
            </div>
